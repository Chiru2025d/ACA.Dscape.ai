          ...
          <div className="about-content">
            ...
            <p>
              <span style={{ color: '#4B4F58' }}>
                ...
                <span style={{ fontWeight: 593 }}>Juris</span>
...
criminal litigation—from Magistrate and Sessions Courts to the High Court. <span style={{ color: '#4B4F58' }}><span style={{ fontFamily: "'Be Vietnam', sans-serif", fontWeight: 593 }}>ACA</span><span style={{ fontWeight: 300 }}>Juris</span></span> offers strategic legal counsel and courtroom representation grounded in practical 
